...
static int	find_word_end(char const *s, char del, int pos)
{
	pos++;
...
static int	calc_word_count(char const *s, char del)
{
	int	pos;
	int	res;
...
static char	*add_word(char const *s, int pos, int fwe_pos)
{
	int		word_len;
	char	*res;
	int		i;
...
static int	handle_bad_malloc(char **str_arr, char *str)
{
	int	i;
